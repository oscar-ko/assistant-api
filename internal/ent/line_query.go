...
func (_q *LineQuery) FirstID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (_q *LineQuery) FirstIDX(ctx context.Context) uuid.UUID {
...
func (_q *LineQuery) OnlyID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (_q *LineQuery) OnlyIDX(ctx context.Context) uuid.UUID {
...
func (_q *LineQuery) IDs(ctx context.Context) (ids []uuid.UUID, err error) {
...
func (_q *LineQuery) IDsX(ctx context.Context) []uuid.UUID {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *LineQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(line.Table, line.Columns, sqlgraph.NewFieldSpec(line.FieldID, field.TypeUUID))
	_spec.From = _q.sql
