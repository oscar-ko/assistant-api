...
const (
	// Label holds the string label denoting the channeltranslationmember type in the database.
	Label = "channel_translation_member"
	...
	EdgeUser = "user"
	// Table holds the table name of the channeltranslationmember in the database.
	Table = "channel_translation_members"
	// ChannelTable is the table that holds the channel relation/edge.
	ChannelTable = "channel_translation_members"
	...
	UserTable = "channel_translation_members"
...
// Columns holds all SQL columns for channeltranslationmember fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
...
// OrderOption defines the ordering options for the ChannelTranslationMember queries.
