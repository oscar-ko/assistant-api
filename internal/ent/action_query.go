...
type ActionQuery struct {
	...
	withRoutes      *ActionRouteQuery
	modifiers       []func(*sql.Selector)
	loadTotal       []func(context.Context, []*Action) error
	withNamedRoutes map[string]*ActionRouteQuery
...
func (_q *ActionQuery) QuerySkill() *SkillQuery {
...
func (_q *ActionQuery) QueryRoutes() *ActionRouteQuery {
...
func (_q *ActionQuery) FirstID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (_q *ActionQuery) FirstIDX(ctx context.Context) uuid.UUID {
...
func (_q *ActionQuery) OnlyID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (_q *ActionQuery) OnlyIDX(ctx context.Context) uuid.UUID {
...
func (_q *ActionQuery) IDs(ctx context.Context) (ids []uuid.UUID, err error) {
...
func (_q *ActionQuery) IDsX(ctx context.Context) []uuid.UUID {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *ActionQuery) WithSkill(opts ...func(*SkillQuery)) *ActionQuery {
	query := (&SkillClient{config: _q.config}).Query()
...
func (_q *ActionQuery) WithRoutes(opts ...func(*ActionRouteQuery)) *ActionQuery {
	query := (&ActionRouteClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *ActionQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Action, error) {
	...
	if query := _q.withSkill; query != nil {
		if err := _q.loadSkill(ctx, query, nodes, nil,
			func(n *Action, e *Skill) { n.Edges.Skill = e }); err != nil {
			return nil, err
		}
	}
	if query := _q.withRoutes; query != nil {
		if err := _q.loadRoutes(ctx, query, nodes,
			func(n *Action) { n.Edges.Routes = []*ActionRoute{} },
			func(n *Action, e *ActionRoute) { n.Edges.Routes = append(n.Edges.Routes, e) }); err != nil {
			return nil, err
		}
	}
	for name, query := range _q.withNamedRoutes {
		if err := _q.loadRoutes(ctx, query, nodes,
			func(n *Action) { n.appendNamedRoutes(name) },
			func(n *Action, e *ActionRoute) { n.appendNamedRoutes(name, e) }); err != nil {
			return nil, err
		}
	}
...
func (_q *ActionQuery) loadSkill(ctx context.Context, query *SkillQuery, nodes []*Action, init func(*Action), assign func(*Action, *Skill)) error {
...
func (_q *ActionQuery) loadRoutes(ctx context.Context, query *ActionRouteQuery, nodes []*Action, init func(*Action), assign func(*Action, *ActionRoute)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(actionroute.FieldActionID)
	}
	query.Where(predicate.ActionRoute(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(action.RoutesColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *ActionQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withSkill != nil {
			_spec.Node.AddColumnOnce(action.FieldSkillID)
		}
	}
...
func (_q *ActionQuery) WithNamedRoutes(name string, opts ...func(*ActionRouteQuery)) *ActionQuery {
	query := (&ActionRouteClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	if _q.withNamedRoutes == nil {
		_q.withNamedRoutes = make(map[string]*ActionRouteQuery)
	}
	_q.withNamedRoutes[name] = query
	return _q
}
