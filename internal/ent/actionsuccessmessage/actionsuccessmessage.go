...
const (
	// Label holds the string label denoting the actionsuccessmessage type in the database.
	Label = "action_success_message"
	...
	// Table holds the table name of the actionsuccessmessage in the database.
	Table = "action_success_messages"
	// ActionTable is the table that holds the action relation/edge.
	ActionTable = "action_success_messages"
	...
	ChannelMessageTable = "action_success_messages"
...
// Columns holds all SQL columns for actionsuccessmessage fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
...
// OrderOption defines the ordering options for the ActionSuccessMessage queries.
