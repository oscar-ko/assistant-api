...
func HasLineWith(preds ...predicate.Line) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := newLineStep()
...
func HasChannelServiceMembersWith(preds ...predicate.ChannelServiceMember) predicate.User {
	return predicate.User(func(s *sql.Selector) {
...
func HasTodoCandidateAssignees() predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasTodoCandidateAssigneesWith(preds ...predicate.TodoCandidateAssignee) predicate.User {
	return predicate.User(func(s *sql.Selector) {
...
// HasOwnedTranslationLocalesWith applies the HasEdge predicate on the "owned_translation_locales" edge with a given conditions (other predicates).
func HasOwnedTranslationLocalesWith(preds ...predicate.TranslationLocale) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := newOwnedTranslationLocalesStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
				p(s)
			}
